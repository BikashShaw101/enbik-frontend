  ...
  return (
    <>
      ...
      <section className="relative bg-dark-hard px-5">
        <div className="container flex flex-col lg:flex-row mx-auto py-10 md:pb-20 lg:place-items-center">
          <div className="lg:flex-1">
            <h2 className="text-white text-center md:text-center font-roboto text-2xl md:text-4xl font-bold md:leading-normal lg:text-left">
            ...
            <p className="text-dark-light text-sm leading-7 mt-6 md:text-center md:text-base lg:text-left ">
              <span className="font-bold italic text-[#83BAC5] mr-2 md:not-italic md:font-normal md:text-dark-light ">
          ...
          <div className="hidden mb-[70px] md:block order-first lg:order-last lg:flex-1">
            <div className="w-3/4 mx-auto relative">
              <div className="w-1/2 h-1/2 bg-[#FC5A5A] absolute rounded-lg top-[10%] -right-[8%]" />
              <div className="w-1/2 h-1/2 bg-white opacity-[.06] absolute rounded-lg -bottom-[10%] -left-[8%]" />
              <div className="w-full rounded-xl bg-white p-3 z-[1] relative ">
                ...
                <div className="p-5">
                  ...
                  <p className="text-dark-light mt-3 text-sm font-semibold lg:text-lg">
                    Our Blog plans offers are priced the same everywhere else.
                  </p>
                </div>
              </div>
            </div>
