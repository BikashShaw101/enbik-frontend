      ...
      <div className="flex flex-col items-end rounded-lg p-4 border border-primary">
        ...
        <div className="flex flex-col-reverse gap-y-2 gap-x-2 pt-2 items-center min-[420px]:flex-row">
          ...
          <button
            type="submit"
            disabled={loading}
            className="lg:px-6 lg:py-2.5 lg:text-base bg-primary border border-primary font-semibold rounded-lg text-white text-sm px-4 py-2 disabled:opacity-70 disabled:cursor-not-allowed "
          >
            {btnLabel}
          </button>
        </div>
